...
const fullname = 'Abiloye Iyanuoluwa';
...
const profileImage = 'images/abiloye.jpeg';
const profileAlt = 'My Portrait';
...
const myFood = ['Ice Cream', 'Fried Rice', 'Chicken'];

// Step 2: place the values of the favorite foods variable into the HTML file
document.querySelector('#food').innerHTML = myFood

// Step 3: declare and instantiate a variable to hold another favorite food
const anotherFood = 'Homemade Chicken Noodle Soup'
