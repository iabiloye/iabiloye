...
// Step 6: Using an else statement, set the message variable to 'Woohoo!/* Lesson 5 */
...
// This will require changes to both the HTML and the JavaScript files  It is the weekend!'
